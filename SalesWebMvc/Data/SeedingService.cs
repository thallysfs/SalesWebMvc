...
namespace SalesWebMvc.Data
{
    ...
    {
        // o atributo _context é do tipo SalesWebMvcContext
        private SalesWebMvcContext _context;

        //no construtor passamos todo o valor recebido em context para _context. Chamado injeção de dependência 
        ...
        public void Seed()
        {
            /* o _context que por sua vez possui a instância DbCotext, comunica com o bd pelas tabelas
             * a propriedade Any() checa se existe algum registro
            */
            if(_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any())
            {
                return; //DB já foi populado (Bd has been seeded)
            }
            ...
            // addRange permite adicionar um rangeou seja vários elementos
